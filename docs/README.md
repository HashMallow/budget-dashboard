...
| [`voice-feedback/audio_feedback_batch_2_to_22.en.md`](voice-feedback/audio_feedback_batch_2_to_22.en.md) | Consolidated requirements by persona (_2–_22) | 🟢 Living |
| [`requirements_audit.md`](requirements_audit.md) | Full gap analysis: transcripts vs codebase | 🟢 Living |
| [`cursor_prompts.md`](cursor_prompts.md) | 9 implementation prompts (all shipped ✅) | 🟢 Living |
...
- **Voice feedback / consolidated requirements** → [`voice-feedback/audio_feedback_batch_2_to_22.en.md`](voice-feedback/audio_feedback_batch_2_to_22.en.md)
- **Voice fixes log** → [`voice-feedback/PROCESSING_LOG.en.md`](voice-feedback/PROCESSING_LOG.en.md)
- **Gap analysis (transcripts vs code)** → [`requirements_audit.md`](requirements_audit.md)
- **Implementation prompts (all shipped)** → [`cursor_prompts.md`](cursor_prompts.md)
